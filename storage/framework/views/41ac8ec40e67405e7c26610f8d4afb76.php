...
<head>
    ...
    <!-- Tautan Favicon -->
    <link rel="icon" href="<?php echo e(asset('favicon.png')); ?>?v=2" type="image/png">    
        ...
        <div class="container mx-auto px-6 max-w-5xl">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                ...
                <div class="bg-white p-10 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 hover:-translate-y-1 transition duration-500" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <form method="POST" action="<?php echo e(route('login.tenant')); ?>" class="space-y-5">
                        <?php echo csrf_field(); ?>
                        <div>
                            <label class="block text-xs font-medium text-gray-500 uppercase tracking-wider mb-2">Email Address</label>
                            <input type="email" name="email" value="<?php echo e(old('email')); ?>" class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-gray-900 focus:bg-white outline-none transition text-sm" placeholder="resident@palazzo.com" required>
                        </div>
                        <div>
                ...
                <div class="bg-white p-10 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 hover:-translate-y-1 transition duration-500" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <form method="POST" action="<?php echo e(route('login.staff')); ?>" class="space-y-5">
                        <?php echo csrf_field(); ?>
                        <div>
                            <label class="block text-xs font-medium text-gray-500 uppercase tracking-wider mb-2">Staff Email</label>
                            <input type="email" name="email" value="<?php echo e(old('email')); ?>" class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-gray-400 focus:bg-white outline-none transition text-sm" placeholder="staff@palazzo.com" required>
                        </div>
                        <div>
                            <label class="block text-xs font-medium text-gray-500 uppercase tracking-wider mb-2">Password</label>
...
</html><?php /**PATH D:\MSI\sistem-apartemen\resources\views/auth/login.blade.php ENDPATH**/ ?>