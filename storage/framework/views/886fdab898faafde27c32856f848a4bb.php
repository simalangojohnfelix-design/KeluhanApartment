...
<body class="bg-gray-50 flex h-screen overflow-hidden" style="font-family: 'Inter', sans-serif;">
    ...
    <main class="flex-1 overflow-y-auto p-10">
        <div class="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <a href="<?php echo e(route('owner.users.create')); ?>" class="bg-gray-900 hover:bg-black text-white px-5 py-2.5 rounded-xl text-sm font-bold shadow-md transition flex items-center gap-2">
            ...
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-gray-100 text-sm">
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        <td class="p-5">
                            <span class="font-bold text-gray-900 block"><?php echo e($user->name); ?></span>
                            <span class="text-xs text-gray-500 mt-1">Dibuat: <?php echo e($user->created_at->format('d M Y')); ?></span>
                        </td>
                        <td class="p-5 font-medium text-gray-700">
                            <?php echo e($user->email); ?>

                            <div class="text-xs text-gray-400 mt-1"><?php echo e($user->phone ?? 'Tanpa Nomor'); ?></div>
                        </td>
                        <td class="p-5">
                            <span class="px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider
                                <?php echo e($user->role == 'owner' ? 'bg-purple-100 text-purple-700' : 
                        ...
                        <td class="p-5">
                            <div class="flex items-center justify-center gap-2">
                                <a href="<?php echo e(route('owner.users.edit', $user->id)); ?>" class="bg-gray-100 hover:bg-gray-200 text-gray-700 px-3 py-1.5 rounded-lg text-xs font-bold transition border border-gray-200">Edit</a>
                                <form action="<?php echo e(route('owner.users.destroy', $user->id)); ?>" method="POST" onsubmit="return confirm('Hapus akun ini secara permanen?');">
...
</html><?php /**PATH D:\MSI\sistem-apartemen\resources\views/owner/users/index.blade.php ENDPATH**/ ?>