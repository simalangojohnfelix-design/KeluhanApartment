...
<body class="bg-gray-50 flex h-screen overflow-hidden" style="font-family: 'Inter', sans-serif;">
    ...
    <aside class="w-64 bg-gray-950 text-white flex flex-col shadow-2xl flex-shrink-0">
        ...
        <nav class="flex-1 py-6 px-4 space-y-2">
            <a href="<?php echo e(route('admin.dashboard')); ?>" class="block px-4 py-3 bg-blue-600 text-white rounded-lg font-bold shadow-md transition">
                Validasi Keluhan
            </a>
            <a href="<?php echo e(route('admin.units.index')); ?>" class="block px-4 py-3 text-gray-400 hover:text-white hover:bg-gray-800 rounded-lg font-medium transition">
                Pantau Unit
            </a>
            <a href="<?php echo e(route('admin.assets.index')); ?>" class="block px-4 py-3 text-gray-400 hover:text-white hover:bg-gray-800 rounded-lg font-medium transition">
                Pantau Aset
            </a>
            <a href="<?php echo e(route('admin.users.index')); ?>" class="block px-4 py-3 text-gray-400 hover:text-white hover:bg-gray-800 rounded-lg font-medium transition">
                Daftar Pengguna
            </a>
        </nav>
...
</html><?php /**PATH D:\MSI\sistem-apartemen\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>