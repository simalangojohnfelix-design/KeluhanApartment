...
<body class="bg-gray-50 flex h-screen overflow-hidden" style="font-family: 'Inter', sans-serif;">
    ...
    <aside class="w-64 bg-gray-950 text-white flex flex-col shadow-2xl flex-shrink-0">
        ...
        <nav class="flex-1 py-6 px-4 space-y-2 text-sm font-medium">
            ...
            <a href="<?php echo e(route('owner.approvals.index')); ?>" class="block px-4 py-2.5 bg-blue-600 text-white font-bold shadow-md rounded-lg transition">
        ...
        <div class="space-y-8 max-w-5xl">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
                <div class="flex justify-between items-start mb-6 border-b border-gray-100 pb-4">
                    <div>
                        <span class="text-xs font-bold uppercase tracking-widest text-blue-600">Work Order #WO-<?php echo e($a->id); ?></span>
                        <h3 class="font-bold text-xl text-gray-900 mt-1" style="font-family: 'Playfair Display', serif;"><?php echo e(optional($a->complaint)->title); ?></h3>
                        <p class="text-sm text-gray-500 mt-1">
                            Unit: <strong class="text-gray-800">No. <?php echo e(optional(optional($a->complaint)->propertyUnit)->unit_number); ?></strong> &bull; 
                            Teknisi: <strong class="text-gray-800"><?php echo e(optional($a->technician)->name); ?></strong>
                        </p>
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6 bg-gray-50 rounded-xl p-6 border border-gray-100">
                    <div>
                        ...
                        <p class="font-bold text-3xl text-blue-600">Rp <?php echo e(number_format($a->cost_estimate, 0, ',', '.')); ?></p>
                        <p class="text-xs text-gray-500 mt-1">Estimasi pengerjaan: <?php echo e($a->estimated_days ?? 1); ?> Hari</p>
                    </div>
                    <div>
                        <p class="text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Tindakan Lapangan</p>
                        <p class="text-sm text-gray-700 leading-relaxed"><?php echo e($a->action_details ?? '-'); ?></p>
                    </div>
                    <div>
                        ...
                        <?php if(is_array($items) && count($items) > 0): ?>
                            <ul class="space-y-1">
                                ...
                                <li class="text-xs flex justify-between border-b border-gray-200 pb-1">
                                    <span class="text-gray-700"><?php echo e($item['name']); ?> <span class="text-gray-400">(<?php echo e($item['qty']); ?>)</span></span>
                                    <span class="font-medium text-gray-800">Rp <?php echo e(number_format($item['price'] ?? 0, 0, ',', '.')); ?></span>
                                </li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </ul>
                        <?php else: ?>
                            <p class="text-sm text-gray-700"><?php echo e($a->spare_parts ?? 'Tidak ada rincian.'); ?></p>
                        <?php endif; ?>
                    </div>
                </div> 

                <!-- Foto Lapangan -->
                <?php if($a->photo_before): ?>
                <div class="mb-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <p class="text-xs font-bold uppercase tracking-wider text-gray-400 mb-2">Foto Kondisi Sebelum</p>
                        <img src="<?php echo e(asset('storage/'.$a->photo_before)); ?>" class="rounded-xl max-h-48 object-cover w-full border border-gray-200 shadow-sm">
                    </div>
                    <?php if($a->photo_after): ?>
                    <div>
                        <p class="text-xs font-bold uppercase tracking-wider text-gray-400 mb-2">Foto Kondisi Sesudah</p>
                        <img src="<?php echo e(asset('storage/'.$a->photo_after)); ?>" class="rounded-xl max-h-48 object-cover w-full border border-gray-200 shadow-sm">
                    </div>
                    <?php endif; ?>
                </div>
                <?php endif; ?> 
                ...
                <form action="<?php echo e(route('owner.approvals.update', $a->id)); ?>" method="POST" class="space-y-4 pt-6 border-t border-gray-200">
...
</html><?php /**PATH D:\MSI\sistem-apartemen\resources\views/owner/approvals/index.blade.php ENDPATH**/ ?>