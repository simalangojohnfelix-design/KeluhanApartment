...
<body class="bg-gray-50 overflow-x-hidden" style="font-family: 'Inter', sans-serif;">
    ...
    <nav class="bg-white shadow-sm border-b border-gray-200 px-8 py-4 flex justify-between items-center" data-aos="fade-down" data-aos-duration="800">
        ...
        <div class="flex items-center space-x-6">
            <span class="text-gray-600 font-medium"><?php echo e(Auth::user()->name); ?></span>
    ...
    <div class="container mx-auto px-8 py-8 max-w-7xl">
        ...
        <div class="bg-blue-50 border border-blue-100 rounded-2xl p-8 mb-8 flex flex-col xl:flex-row justify-between items-start xl:items-center gap-6" data-aos="fade-up" data-aos-duration="800" data-aos-delay="100">
            ...
            <div class="flex flex-col sm:flex-row gap-4 w-full xl:w-auto">
                <a href="<?php echo e(route('tenant.complaints.index')); ?>" class="bg-white text-blue-600 border border-blue-200 px-6 py-4 rounded-xl font-bold hover:bg-blue-50 transition shadow-sm whitespace-nowrap text-center flex-1 sm:flex-none">
                    Lihat Riwayat Keluhan
                </a>
                <a href="<?php echo e(route('tenant.complaints.create')); ?>" class="bg-blue-600 text-white px-6 py-4 rounded-xl font-bold hover:bg-blue-700 transition shadow-md whitespace-nowrap text-center flex-1 sm:flex-none">
                    + Buat Laporan Baru
                </a>
            </div>
        </div>
        ...
        <div class="mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <?php $__currentLoopData = $assets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $asset): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="bg-white p-5 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition" data-aos="fade-up" data-aos-duration="600" data-aos-delay="<?php echo e($animationDelay); ?>">
                        <div class="flex justify-between items-start mb-4">
                            <div class="p-2 <?php echo e($bgColor); ?> rounded-lg">
                                <svg class="w-6 h-6 <?php echo e($iconColor); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <?php echo $iconSvg; ?>

                                </svg>
                            </div>
                            <span class="<?php echo e($bgColor); ?> <?php echo e($textColor); ?> text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wider">
                                <?php echo e($asset->condition); ?>

                            </span>
                        </div>
                        <h3 class="font-bold text-gray-800 text-lg"><?php echo e($asset->name); ?></h3>
                        <p class="text-sm text-gray-500 mt-1">Kategori: <?php echo e($asset->category); ?></p>
                    </div>
...
</html><?php /**PATH D:\MSI\sistem-apartemen\resources\views/tenant/dashboard.blade.php ENDPATH**/ ?>