...
<body class="bg-[#F8F9FA] text-gray-800 antialiased overflow-x-hidden">
    <nav class="bg-white/80 backdrop-blur-md sticky top-0 z-50 border-b border-gray-100 transition-all duration-300">
        <div class="container mx-auto px-6 py-4 flex justify-between items-center">
            ...
            ?>
            <a href="<?php echo e($homeRoute); ?>" class="font-playfair font-bold text-2xl tracking-wide text-gray-900">Palazzo Palace</a>
            <div>
                <?php if(auth()->guard()->check()): ?>
                    <span class="mr-4 text-sm font-medium text-gray-600"><?php echo e(auth()->user()->name); ?></span>
...
</html><?php /**PATH D:\MSI\sistem-apartemen\resources\views/layouts/app.blade.php ENDPATH**/ ?>